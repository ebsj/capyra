...
Brand illustration is separate: logo and mascots live in [`docs/design/`](../design/README.md) and may appear on the site, webapp, PDF reports and Resend email. Do not derive a custom shadcn theme from those drawings.
